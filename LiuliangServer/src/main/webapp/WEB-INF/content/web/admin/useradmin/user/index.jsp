...
<html>
	...
	function ajaxSearch(page) {
		...
		var url = "${ctx}/web/admin/useradmin/user/list";
		$.ajax( {
			url : url,
			type : 'post',
			data : {
	...
	function editInput(userId) {
		...
		var url = "${ctx}/web/admin/useradmin/user/edit_input";
		$.ajax( {
			url : url,
			type : 'post',
			data : {
	...
	function edit() {
		...
		$(".btn-cancel").button('loading');
		$(".btn-primary").button('loading');
		var url = "${ctx}/web/admin/useradmin/user/edit";
		$.ajax({
			url:url,
			type:'post',
			data:{
	...
	function add() {
		...
		$(".btn-cancel").button('loading');
		$(".btn-primary").button('loading');
		var url = "${ctx}/web/admin/useradmin/user/add";
		$.ajax({
			url:url,
			type:'post',
			data:{
