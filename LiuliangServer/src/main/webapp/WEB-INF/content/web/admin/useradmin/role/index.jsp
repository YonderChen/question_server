...
<html>
	...
	function ajaxSearch(page) {
		...
		var url = "${ctx}/web/admin/useradmin/role/list";
		$.ajax( {
			url : url,
			type : 'post',
			data : {
	...
	function addInput() {
		...
		var url = "${ctx}/web/admin/useradmin/user/add_input";
		$.ajax( {
			url : url,
			type : 'post',
			data : {
	...
	function editInput(roleId) {
		...
		var url = "${ctx}/web/admin/useradmin/role/edit_input";
		$.ajax( {
			url : url,
			type : 'post',
			data : {
	...
	function edit() {
		...
		$(".btn-cancel").button('loading');
		$(".btn-primary").button('loading');
		var url = "${ctx}/web/admin/useradmin/role/edit";
		$.ajax({
			url:url,
			type:'post',
			data:{
	...
	function addInput() {
		...
		var url = "${ctx}/web/admin/useradmin/role/add_input";
		$.ajax( {
			url : url,
			type : 'post',
			data : {
	...
	<body>
		...
		<div class="rightinfo">
			<ul class="seachform">
		    	...
		    	<ul class="seachform">
		    	<li>
		    	<button class="btn btn-primary" type="button" onclick="javascript:addInput();" data-toggle="button" data-loading-text="<i class='icon-plus'></i>&nbsp;新增角色"><i class="icon-plus"></i>&nbsp;新增角色</button>
		    	</li>
		      </ul>
	...
	<div id="addModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true" style="z-index:100000;position: absolute;" data-backdrop="static">
		<div class="modal-header">
			<button type="button" class="close btn-cancel" data-dismiss="modal" aria-hidden="true" data-toggle="button" data-loading-text="×">×</button>
