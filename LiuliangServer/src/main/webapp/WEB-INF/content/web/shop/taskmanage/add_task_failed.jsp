...
<div class="breadcrumbs">
    <div class="wrap"><a href="${ctx}">首页</a> &gt; <a href="#">发布任务</a> &gt; <a href="#">发布失败</a> </div>
</div>
<div class="container">
    <div class="Shadowbox">
        ...
        <div class="register">
            ...
            <div class="register-title">
            		...
            		<span class="bram-title">发布失败</span>
                    <div class="Process">
                        <ul class="clearfix">
                            ...
                            <li class="cur" style="width:20%"><em class="Processyes">5<i></i></em><span class="">选择增值服务</span><strong></strong></li>
                            <li class="Processlast" style="width:82px"><em class="Processing">6<i></i></em><span>发布任务</span><strong></strong></li>
                        </ul>
                    </div>
            </div>
            
            <h1 class="issue-task-thh1">任务发布失败，请重试</h1>
