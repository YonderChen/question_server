	...
	<jsp:include page='help_content_left.jsp' flush="true"></jsp:include>
    	...
    	<div class="business-right-comm">        	
        	<div class="guide-help-center">
            	<h1>新手指南<span> —如何发布直通车流量任务？</span></h1>
                <h2>第一步：如下图：点击【发布流量任务】，进入发布流量任务页面点击【选择平台】（淘宝、天猫、京东）；也可通过【个人中心】，点击【发布任务】</h2>
                <h2>第二步：【选择店铺】</h2>
                
                <h2>第三步：【选择流量类型】（自然搜索流量、<span class="red">直通车流量</span>），点击【下一步】</h2>
                <img src="${ctx}/static_shop/images/help_center/task1ztc.jpg">
                <h2>第四步：填写【流量信息】<br>按照图中要求正确填写相应资料，信息填写正确后，点击【下一步】</h2>
                <img src="${ctx}/static_shop/images/help_center/task2.jpg">
                <h2>第五步：选择【增值服务】<br>按照图中要求正确填写相应资料，信息填写正确后，点击【立即发布】</h2>
                <img src="${ctx}/static_shop/images/help_center/task3.jpg">
                <h2>第六步：发布任务成功，显示【支付成功】提示</h2>
                <img src="${ctx}/static_shop/images/help_center/task4.jpg">
                
                <h3>常见问题</h3>
                <p>问：发布一个流量任务需要填几个搜索关键词啊？</p>
                <p>答：发布任务需填写关键词为3-5个。多填关键词是为了防止一个关键词搜索不到您的商品。另请会员注意，在填写关键词时，需保证所填的关键词都可以搜到商品，否则造成的流量流失情况本网站概不负责。</p>
                <br>
                <p>问：发布任务设置的访客流量数有标准或者要求吗？</p>
                <p>答：这个是没有要求的，可以自由设置进店的访客数量，是根据您店铺转化率和单品转化率而定的。</p>
                <br>
                <p>问：增值服务可以不选吗？</p>
                <p>答：增值服务不是必选项，但建议选择，选择的话有助于更快更好的完成任务。</p>
                <br>
                <p>问：已发布任务的完成进度是在哪里查看呢？</p>
                <p>答：任务状态是在您【个人中心】-【任务列表】-【任务详情】中打开进行查看哦。</p>
