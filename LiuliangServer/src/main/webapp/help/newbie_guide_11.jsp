	...
	<jsp:include page='help_content_left.jsp' flush="true"></jsp:include>
    	...
    	<div class="business-right-comm">        	
        	<div class="guide-help-center">
            	<h1>新手指南<span> —如何查询积分使用记录？</span></h1>
                <h2>第一步：请先登录</h2>
                <h2>第二步：点击进入【个人中心】</h2>
                <h2>第三步：点击【积分记录】</h2>
                <img src="${ctx}/static_shop/images/help_center/pay_integral5.jpg">
                <h2>第四步：查看积分使用记录</h2>
                <img src="${ctx}/static_shop/images/help_center/pay_integral6.jpg">
                
                <h3>常见问题</h3>
                <p>问：购买积分是什么样的评分标准？</p>
                <p>答：支付 500 元，总计获得: 5,000 积分（即1访客=0.3元）<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;支付 1,000 元，总计获得: 10,000 积分（即1访客=0.3元）<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;支付 2,000 元，总计获得: 21,818 积分（即1访客=0.275元）<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;支付 5,000 元，总计获得: 60,000 积分（即1访客=0.25元）<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;支付 10,000 元，总计获得: 133,333 积分 （即1访客=0.225元）<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;支付 20,000 元，总计获得: 300,000 积分 （即1访客=0.2元）<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;一次性购买越多积分，折扣越大哦。</p>
                <br>
                <p>问：购买的积分在网站有哪些用途？</p>
