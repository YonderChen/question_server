	...
	<jsp:include page='help_content_left.jsp' flush="true"></jsp:include>
    	...
    	<div class="business-right-comm">        	
        	<div class="guide-help-center">
                ...
                <h2>第一步：请先登录</h2>
                <h2>第二步：如下图：点击进入【个人中心】，下拉至【任务管理】，点击【详情】即可查看任务</h2>
                <img src="${ctx}/static_shop/images/help_center/see_task.jpg">
                <h2>第三步：详情中，可查看任务信息、支付信息。可进行操作修改、撤销任务</h2>
                <img src="${ctx}/static_shop/images/help_center/see_tasks.jpg">
