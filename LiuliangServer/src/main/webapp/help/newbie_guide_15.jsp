	...
	<jsp:include page='help_content_left.jsp' flush="true"></jsp:include>
    	...
    	<div class="business-right-comm">        	
        	<div class="guide-help-center">
            	<h1>新手指南<span> —如何对已发布的任务进行修改？</span></h1>
                <h2>第一步：请先登录</h2>
                <h2>第二步：如下图：点击进入【个人中心】，点击【修改任务】提示（<span style="color:#f00;">修改的任务将在次日生效</span>）</h2>
                <img src="${ctx}/static_shop/images/help_center/task_update1.jpg">
                <h2>第三步：如图：修改【增加每日访客数】，如确认修改可点击【提交】；<br>如要放弃修改可点击【取消】</h2>
                <img src="${ctx}/static_shop/images/help_center/task_update2.jpg">
                <h2>第四步：修改任务成功，显示【修改成功】</h2>
                <img src="${ctx}/static_shop/images/help_center/task_update3.jpg">
