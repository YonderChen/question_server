	...
	<jsp:include page='help_content_left.jsp' flush="true"></jsp:include>
    	...
    	<div class="business-right-comm">
        	...
        	<div class="notice-center">
                ...
                <p>为了感谢各位对流量符上线以来的信赖和支持，本网站开展限时特惠活动，回馈商家。</p>
                
                <p style="color:#FF0707">即日起，原价50元/月的会员费，调整为20元/月。</p>
                <p><b>在此之前以50元/月购买会员或续费会员的商家，每买一个月都将获得1.5个月的会员时长的补偿</b>。如：买了三个月会员，就会在原来的会员时间上面，再加<span style="color:#FF0707">1.5*3=4.5</span>个月的会员时间，总共的会员时间就是<span style="color:#FF0707">3+4.5=7.5</span>个月。<span style="color:#FF0707">和现有价格购买会员的时长是一样的。</span></p>
                
                <p>以上优惠的截止时间另行通知，时间有限，希望各位商家抓紧时间购买会员或续费会员。</p>
                <p style="text-align:right; color:#209CD7; margin-top:30px;">流量符官方</p>
                <p style="text-align:right;">2015 . 1 . 12</p>
        	</div>
