...
<html>
	...
	<div class="rightinfo">
		<form id="api_test_form" action="${ctx}/rs/yjn/post" method="post" enctype="multipart/form-data">
			<div style="float: none; width: 1220px; height: 270px;">
				<div style="float: left;">
					<table border="1">
					  ...
					  <tr>
					    <td align="right">[文件, file] <b>file</b>：</td>
					    <td><input name="file" id="file" type="file" class="span2" value="" placeholder="文件"/></td>
					  </tr>
					</table>
				</div>
