...
<s:else>
				...
				<tbody>
					<s:iterator value="#request.pageBean.list" id="record" status="L">
					<tr>
						<td>
							${record.id}
						</td>
						...
						<td>
							<button class="btn btn-link" type="button" onclick="loadVoice('${record.voiceUrl }');" data-toggle="button" data-loading-text="<i class='icon-pencil'></i>&nbsp;加载音频"><i class="icon-pencil"></i>&nbsp;加载音频</button>
						</td>
						<td>
