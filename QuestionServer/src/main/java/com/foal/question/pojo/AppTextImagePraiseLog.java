...
@Entity
@Table(name = "app_text_image_praise_log")
@Cache(region = "yonderHibernateCache", usage = CacheConcurrencyStrategy.READ_WRITE)
public class AppTextImagePraiseLog implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8412907809732490889L;
	private String opId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AppTextImagePraiseLog other = (AppTextImagePraiseLog) obj;
