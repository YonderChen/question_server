...
@Entity
@Table(name = "app_text_voice_share_log")
@Cache(region = "yonderHibernateCache", usage = CacheConcurrencyStrategy.READ_WRITE)
public class AppTextVoiceShareLog implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -7411653748521863514L;
	private String opId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AppTextVoiceShareLog other = (AppTextVoiceShareLog) obj;
