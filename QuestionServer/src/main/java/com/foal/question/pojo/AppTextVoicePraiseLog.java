...
@Entity
@Table(name = "app_text_voice_praise_log")
@Cache(region = "yonderHibernateCache", usage = CacheConcurrencyStrategy.READ_WRITE)
public class AppTextVoicePraiseLog implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8987340007164756167L;
	private String opId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AppTextVoicePraiseLog other = (AppTextVoicePraiseLog) obj;
