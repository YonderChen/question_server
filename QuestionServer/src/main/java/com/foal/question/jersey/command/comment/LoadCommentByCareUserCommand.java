...
public class LoadCommentByCareUserCommand implements ICommand {
	...
	public ResultMap handle(Param param) {
		...
		List<AppComment> commentList = appCommentService.getRecordCommentByCareUser(uid, page, pageSize);
