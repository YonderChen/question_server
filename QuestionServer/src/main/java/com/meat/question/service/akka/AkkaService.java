package com.meat.question.service.akka;
...
import com.meat.question.config.Constant;
import com.meat.question.service.akka.send.AkkaRemoteInfo;
import com.meat.question.service.akka.send.SendBalanceRouteActor;
...
public class AkkaService {
	...
	public void init() {
		...
		actorSystem = ActorSystem.create("QuestionServer", createConfig());
	...
	private AkkaRemoteInfo getAkkaRemoteInfo(String host, int port, int routerCount, String routerName) {
		...
		remote.setServiceName("QuestionServer");
		remote.setActorName("questionActor");
		remote.setHost(host);
		remote.setPort(port);
